          ...
          <div className="flex justify-center mt-12">
            ...
            <div className="mt-10 w-full">
              <div className="p-2 border">
                <img src={retreivedUser.profileUrl}  alt={retreivedUser.name} loading="lazy"      className="w-28 h-28 mr-2 rounded-full"/>
              </div>
                    ...
                    <button
                      ...
                      className={
                        isFollowedByLoggedInUser
                          ? "rounded-full py-2 px-4 text-black font-semibold text-sm ml-auto bg-white borderbutton-black--clicked"
